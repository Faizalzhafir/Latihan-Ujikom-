        ...
        <div class="col-12">
                <div class="card mb-0">
                    ...
                    <div class="d-md-flex justify-content-between mb-9">
                        ...
                        <p class="card-subtitle mb-0">Lihat Data Konsumen </p>
                        </div>
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li>
                                    <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('konsumen.create') }}">
                                        <i class="fs-4 ti ti-plus"></i>Add
                                    </a>
                                    </li>
                                    <li>
                                    <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('konsumen.edit', ['id' => $item->id_konsumen ]) }}">
                                        <i class="fs-4 ti ti-edit"></i>Edit
                                    </a>
                                    </li>
                                    <li>
                                    <form action="{{ route('konsumen.delete', ['id' => $item->id_konsumen ]) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
...
<body>
    ...
    <a href="{{ route('konsumen.create') }}">Tambah</a>
    ...
    <table align="center" border="1px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->alamat }}</td>
                <td>
                    <a href="{{ route('konsumen.edit', ['id' => $item->id_konsumen ]) }}">Edit</a>
                    <form action="{{ route('konsumen.delete', ['id' => $item->id_konsumen ]) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" onclick="return confirm('Apakah anda yakin ingin menghapus {{ $item->nama }} ?') " >Hapus</button>
                    </form>
                </td>
            </tr>
            @endforeach
