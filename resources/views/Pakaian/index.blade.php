        ...
        <div class="col-12">
                <div class="card mb-0">
                    ...
                    <div class="d-md-flex justify-content-between mb-9">
                        ...
                        <p class="card-subtitle mb-0">Lihat Data Pakaian </p>
                        </div>
                        <div class="d-flex align-items-center">
                        <form class="position-relative me-3 w-100">
                            <input type="text" name="search" value="{{ $request->get('search') }}" class="form-control search-chat py-2 ps-5" id="text-srh" placeholder="Search">
                    ...
                    <div class="table-responsive overflow-x-auto latest-reviews-table">
                        ...
                        <tbody>
                            ...
                            <td>
                                <p class="mb-0">{{ $item->nama_pakaian }}</p>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li>
                                    <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('pakaian.create') }}">
                                        <i class="fs-4 ti ti-plus"></i>Add
                                    </a>
                                    </li>
                                    <li>
                                    <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('pakaian.edit', ['id' => $item->id_pakaian ]) }}">
                                        <i class="fs-4 ti ti-edit"></i>Edit
                                    </a>
                                    </li>
                                    <li>
                                    <form action="{{ route('pakaian.delete', ['id' => $item->id_pakaian ]) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
...
<body>
    <h1 align="center">Data Daftar Pakaian</h1>
    <h3 align="center">Data Pakaian</h3>
    <a href="{{ route('pakaian.create') }}">Tambah</a>
    ...
    <table border="1px" align="center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->harga }}</td>
                <td>
                    <a href="{{ route('pakaian.edit', ['id' => $item->id_pakaian]) }}">Edit</a>
                    <form action="{{ route('pakaian.delete', ['id' => $item->id_pakaian]) }}" method="post" style="display:inline">
                        @csrf
                        @method('DELETE')

                        <button type="submit" onclick="return confirm('Apakah kamu yakin ingin menghapus {{ $item->nama_pakaian}} ?')">Hapus</button>
                    </form>
                </td>
            </tr>
            @endforeach
